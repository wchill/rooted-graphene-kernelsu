...
# Pixel 6 Pro is the "raviole" device family. The codename "raven" is the
# GrapheneOS build target for the Pixel 6 Pro specifically.

DEVICE_GROUP="raviole"
DEVICE_REPO="https://github.com/GrapheneOS/device_google_raviole.git"
...
KERNEL_BUILD_COMMAND="./build_raviole.sh --page_size=16k --lto=full"
...
KERNEL_IMAGE_REPO="https://github.com/GrapheneOS/device_google_raviole-kernels_6.1.git"
